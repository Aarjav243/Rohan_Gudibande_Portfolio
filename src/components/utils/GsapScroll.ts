  ...
  if (window.innerWidth > 1024) {
    if (character) {
      tl1
        ...
        .to(".landing-container", { opacity: 0, duration: 0.4, ease: "power2.inOut" }, 0)
      ...
      tl2
        ...
        .to(".about-section", { y: "30%", duration: 6, ease: "power3.inOut" }, 0)
        .to(".about-section", { opacity: 0, delay: 3, duration: 2, ease: "power2.inOut" }, 0)
        .fromTo(
          ".character-model",
          { pointerEvents: "inherit" },
          { pointerEvents: "none", x: "-12%", delay: 2, duration: 5, ease: "power3.inOut" },
          0
        )
        ...
        .fromTo(
          monitor.position,
          { y: -10, z: 2 },
          { y: 0, z: 0, delay: 1.5, duration: 3, ease: "power3.inOut" },
          0
        )
        .fromTo(
          ".character-rim",
          { opacity: 1, scaleX: 1.4 },
          { opacity: 0, scale: 0, y: "-70%", duration: 5, delay: 2, ease: "power3.inOut" },
          0.3
        );
      ...
      tl3
        ...
        .fromTo(".whatIDO", { y: 0 }, { y: "10%", duration: 2, ease: "power2.inOut" }, 0)
        .to(character.rotation, { x: -0.04, duration: 2, ease: "power2.inOut" }, 0);
    }
  } else {
    if (character) {
